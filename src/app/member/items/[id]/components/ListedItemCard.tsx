      ...
      <CardContent className="p-8">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-2">
            ...
            {listingInfo?.item_price && (
              <div className="flex items-center justify-between">
                <span className="text-xl font-medium">
                  {listingInfo.member_earnings
                    ? (
                      <>
                        {formatCurrency(listingInfo.member_earnings)}
                        <span className="text-sm text-muted-foreground ml-1">(excl. store %)</span>
                      </>
                    )
                    : "N/A"}
                </span>
          ...
          <div className="p-4 bg-gray-50 rounded-lg text-sm border border-gray-100 shadow-sm mb-6">
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1">
                <p className="font-medium">{listingInfo.store_name}</p>
                {listingInfo.listed_at && (
                  <p className="text-sm text-muted-foreground mt-1">
                    Listed at {formatDate(listingInfo.listed_at)}
                  </p>
                )}
              </div>
            </div>
