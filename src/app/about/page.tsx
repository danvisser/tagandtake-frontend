...
import { Store, Recycle, Lightbulb } from "lucide-react";
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-12 max-w-6xl">
      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-12 mb-10 md:mb-16">
        ...
        <section>
            <h3 className="text-lg md:text-xl lg:text-2xl font-normal mb-3 inline-flex items-center gap-2 text-muted-foreground">
              <Recycle className="h-5 w-5 md:h-6 md:w-6 text-primary/80" />
              Keeping it circular
            </h3>
          ...
          <section>
            <h3 className="text-lg md:text-xl lg:text-2xl font-normal mb-3 inline-flex items-center gap-2 text-muted-foreground">
              <Store className="h-5 w-5 md:h-6 md:w-6 text-primary/80" />
          ...
          <section>
            <h3 className="text-lg md:text-xl lg:text-2xl font-normal mb-3 inline-flex items-center gap-2 text-muted-foreground">
              <Lightbulb className="h-5 w-5 md:h-6 md:w-6 text-primary/80" />
              Leading the way
            </h3>
            <p className="text-muted-foreground text-sm md:text-base">
